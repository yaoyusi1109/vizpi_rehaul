...
BlockMirror.prototype.validateConfiguration = function (configuration) {
  ...
  if ('zoom' in configuration) {
    this.configuration.zoom = configuration.zoom;
  } else {
    this.configuration.zoom = {
      controls: true
    };
  }
  if ('scrollbars' in configuration) {
    this.configuration.scrollbars = configuration.scrollbars;
  } else {
    this.configuration.scrollbars = true;
  }
  if ('trashcan' in configuration) {
    this.configuration.trashcan = configuration.trashcan;
  } else {
    this.configuration.trashcan = true;
  }
...
function BlockMirrorBlockEditor(blockMirror) {
  ...
  var blocklyOptions = {
    ...
    oneBasedIndex: false,
    readOnly: blockMirror.configuration.readOnly,
    scrollbars: blockMirror.configuration.scrollbars,
    trashcan: blockMirror.configuration.trashcan,
